...
# 41 "parser.mly"
      ...
      Imp.Glb_Etr
      (Def_CoPrd (ref
        { coprd_xs=(fst _2); coprd_name=(snd _2); coprd_cns=_4 }))
      )
# 1695 "parser.ml"
         in
...
# 46 "parser.mly"
      ...
      Imp.Glb_Etr
        (Def_Prd (ref
        { prd_xs=(fst _2); prd_name=(snd _2); prd_cns=_4 }))
      )
# 1753 "parser.ml"
         in
...
# 2194 "parser.ml"
    ...
    | MenhirState19 | MenhirState23 | MenhirState86 | MenhirState96 | MenhirState89 | MenhirState91 ->
        ...
        | ARR | ARR_END | CO_PRD_STT ->
            ...
            let _v : 'tv_h_frm = 
# 188 "parser.mly"
        ( Imp.Opr { src=Imp.Top; dst=Imp.Top; opr=_1} )
# 2222 "parser.ml"
             in
