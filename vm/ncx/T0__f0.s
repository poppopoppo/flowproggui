...
main:
	...
	not r12
	call NS_E_4945
	mov QWORD [CST_DYN_4945+8*1],rax
	mov rbx,0
	setc bl
	mov QWORD [CST_DYN_4945],rbx
	mov rdi,0
	call mlc
	mov rdi,rax
	clc
...
;push_reg
	...
	call mlc
	mov rdi,rax
	mov rsi,[cst_stg_4918+8*1]
	mov [rdi+8*2],rsi
	mov rsi,[cst_stg_4918+8*0]
	mov [rdi+8*1],rsi
	mov rdx,[rdi]
	and rdx,~0xFFFF
	or rdx,0x10000
...
; unknown
	...
	pop rdi
	and r12,~0b10
	jmp emt_set_ptn_1_lb_4920
emt_set_ptn_0_lb_4919:
	mov r9,QWORD [set_ptn_vct+8*1+16*0]
	or r12,0b10
emt_set_ptn_1_lb_4920:
; ; emt_dec_ptn 0'
; unknown
	bt r12,0
	jc emt_dec_ptn_0_lb_4921
;push_reg
	push QWORD r8
	push QWORD r9
	mov rdi,r8
...
;push_reg
	...
	call mlc
	mov rdi,rax
	mov rsi,[cst_stg_4922+8*1]
	mov [rdi+8*2],rsi
	mov rsi,[cst_stg_4922+8*0]
	mov [rdi+8*1],rsi
	mov rdx,[rdi]
	and rdx,~0xFFFF
	or rdx,0x10000
...
; unknown
	...
	pop rdi
	and r12,~0b100
	jmp emt_set_ptn_1_lb_4924
emt_set_ptn_0_lb_4923:
	mov r10,QWORD [set_ptn_vct+8*1+16*0]
	or r12,0b100
emt_set_ptn_1_lb_4924:
; ; emt_dec_ptn 0'
; unknown
	bt r12,0
	jc emt_dec_ptn_0_lb_4925
;push_reg
	push QWORD r8
	push QWORD r9
	push QWORD r10
...
; boxed
	...
	pop rdi
	clc
	jmp emt_get_ptn_1_lb_4933
emt_get_ptn_0_lb_4932:
; unboxed
	stc
emt_get_ptn_1_lb_4933:
	mov QWORD r11,r9
	mov rbx,0
	setc bl
...
; boxed
	...
	pop rdi
	clc
	jmp emt_get_ptn_1_lb_4937
emt_get_ptn_0_lb_4936:
; unboxed
	stc
emt_get_ptn_1_lb_4937:
	mov QWORD r9,r10
	mov rbx,0
	setc bl
	mov r14,QWORD [out_tp_p]
...
; boxed
	...
	pop rdi
	clc
	jmp emt_get_ptn_1_lb_4941
emt_get_ptn_0_lb_4940:
; unboxed
	stc
emt_get_ptn_1_lb_4941:
	mov QWORD r9,r8
	mov rbx,0
	setc bl
	mov r14,QWORD [out_tp_p]
...
;push_reg
	...
	call mlc
	mov rdi,rax
	mov rsi,[cst_stg_4946+8*1]
	mov [rdi+8*2],rsi
	mov rsi,[cst_stg_4946+8*0]
	mov [rdi+8*1],rsi
	mov rdx,[rdi]
	and rdx,~0xFFFF
	or rdx,0x10000
...
; unknown
	...
	pop rdi
	and r12,~0b10
	jmp emt_set_ptn_1_lb_4948
emt_set_ptn_0_lb_4947:
	mov r9,QWORD [set_ptn_vct+8*1+16*0]
	or r12,0b10
emt_set_ptn_1_lb_4948:
; ; emt_dec_ptn 0'
; unknown
	bt r12,0
	jc emt_dec_ptn_0_lb_4949
;push_reg
	push QWORD r8
	push QWORD r9
	mov rdi,r8
...
;pop_reg
	pop QWORD r9
	pop QWORD r8
emt_dec_ptn_0_lb_4949:
; emt_get_ptn 1'
	bt r12,1
	jc emt_get_ptn_0_lb_4950
; boxed
	push rdi
	mov rdi,r9
	call inc_r
	...
	pop rdi
	clc
	jmp emt_get_ptn_1_lb_4951
emt_get_ptn_0_lb_4950:
; unboxed
	stc
emt_get_ptn_1_lb_4951:
	mov QWORD r8,r9
	mov rbx,0
	setc bl
	mov r14,QWORD [out_tp_p]
