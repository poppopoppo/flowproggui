      ...
      let (e1,_) =
        Array.fold_left
          (fun (e1,i) r ->
             let ei0 =
               "\tpush "^dst^"\n" in
             let ei1 = emt_get_ptn s tbv idx r "rax" in
             let ei2 =
               "\tmov rdx,"^"rax"^"\n"^
               "\tpop rdi\n"^
      ...
      let (e0,_) =
        Array.fold_left
          (fun (e0,i) r ->
             ...
             let e1 = emt_set_ptn s tbv idx r in
             let e2 =
               "\tpop rdi\n" in
             (e0^ei^e1^e2,i+1))
          ("",0) rs in
            ...
            ( match n with
              | Tkn.Etr_N "add" ->
                ...
                let e0 =
                  ...
                  "\tmov rdi,r9\n"^
                  "\tstc\n"^
                  (emt_set_ptn s "r12" emt_reg iy) in
                c0^e0
              ...
              | Tkn.Etr_N f ->
                ...
                let e0 =
                  "\nmov rbx,0\n"^
                  "\nnot rbx\n"^
                  (emt_ptn_set_ptn s "rbx" emt_reg emt_reg_tmp ix i0)^
