...
%include "DATA.s"
LB_5_H: dq 0x25
LB_5: db 32,79,73,74,70,79,73,69,74,32,10,9,111,105,102,101,111,106,32,79,75,32,79,75,74,70,79,73,74,111,102,111,32,111,106,76,76,0,0,0,0,0,0,0,0,0
LB_6_H: dq 0x3
...
%include "START.s"
	jmp RTM_0
LB_0: ;; #0x2d◂◂(_none◂{}) 128'(= {| ? |} ) ⊢ { } : (_arr◂{ }◂_arr◂{ }◂_r8◂→{ })
JMP_0:
	mov r8,GLX(0x80)
	GET_LEN rsi,r8
	mov rax,0 
