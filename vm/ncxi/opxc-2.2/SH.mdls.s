...
LB_94: db 32,58,32,95,67,108,114,226,151,130,57,51,49,39,40,49,41,10,0
...
LB_111: db 32,58,32,95,67,108,114,226,151,130,95,114,54,52,226,151,130,10,0
LB_114: db 32,58,32,95,67,108,114,226,151,130,95,114,54,52,226,151,130,10,0
section .text
	unt_1: dq (1<<48)
	unt_2: dq (2<<48)
	unt_3: dq (3<<48)
...
ss_end_rcd_31:
	...
	jmp RTM_0
;; rfb=f
LB_0: ;; #84◂◂(_none◂{}) 128'(= r ) ⊢ { 0'(= r ) 1'(= {| ? |} ) } : (_r64◂→{ _r64◂ _arr◂_lst◂567'(=568'(0))})
JMP_0:
...
; .dlt.ptn 129'(= r )
	...
	ret
;; rfb=t
LB_11: ;; #83◂◂(_none◂{}) { { 146'(= {| l |} ) 147'(= r ) } 148'(5)◂149' } ⊢ { { 0'(= {| l |} ) 1'(6)◂2' } 3'(5)◂4' } : ({ { _s8◂ _r64◂} _lst◂{ _s8◂ _r64◂}}→{ { _s8◂ _opn◂_r64◂} _lst◂{ _s8◂ _r64◂}})
JMP_11:
...
LB_16:
;; %0~150'(= {| l |} )%1~151'(= r )%3~154'(= {| l |} )%4~155'(= r )%5~156'(5)◂157'
; ##83 { { 150'(= {| l |} ) 151'(= r ) } 156'(5)◂157' } ⊢ { { 158'(= {| l |} ) 159'(6)◂160' } 161'(5)◂162' }
	lea rsp,[rsp-8*2]
...
LB_23:
	ret
;; rfb=f
LB_10: ;; #86◂◂(_some◂→[ 83]) { { 135'(= r ) 136'(= {| ? |} ) } { 137'(= {| l |} ) 138'(= r ) } } ⊢ { { 0'(= r ) 1'(= {| ? |} ) } { 2'(= {| l |} ) 3'(6)◂4' } } : ({ { _r64◂ _arr◂_lst◂{ _s8◂ _r64◂}} { _s8◂ _r64◂}}→{ { _r64◂ _arr◂_lst◂{ _s8◂ _r64◂}} { _s8◂ _opn◂_r64◂}})
JMP_10:
...
; #→[ 83] { { 141'(= {| l |} ) 142'(= r ) } 144'(5)◂145' } ⊢ { { 164'(= {| l |} ) 165'(6)◂166' } 167'(5)◂168' }
	lea rsp,[rsp-8*3]
...
LB_36:
	ret
;; rfb=t
LB_41: ;; #82◂◂(_none◂{}) { { 185'(= {| l |} ) { } } 186'(5)◂187' } ⊢ { { 0'(= {| l |} ) 1'(6)◂2' } 3'(5)◂4' } : ({ { _s8◂ { }} _lst◂{ _s8◂ _r64◂}}→{ { _s8◂ _opn◂_r64◂} _lst◂{ _s8◂ _r64◂}})
JMP_41:
...
LB_46:
;; %0~188'(= {| l |} )%2~191'(= {| l |} )%3~192'(= r )%4~193'(5)◂194'
; ##82 { { 188'(= {| l |} ) { } } 193'(5)◂194' } ⊢ { { 195'(= {| l |} ) 196'(6)◂197' } 198'(5)◂199' }
	lea rsp,[rsp-8*2]
...
EXH_47:
	...
	jmp rax
;; rfb=f
LB_40: ;; #88◂◂(_none◂{}) { { 176'(= r ) 177'(= {| ? |} ) } 178'(= {| l |} ) } ⊢ { { 0'(= r ) 1'(= {| ? |} ) } { 2'(= {| l |} ) 3'(6)◂4' } } : ({ { _r64◂ _arr◂_lst◂{ _s8◂ _r64◂}} _s8◂}→{ { _r64◂ _arr◂_lst◂{ _s8◂ _r64◂}} { _s8◂ _opn◂_r64◂}})
JMP_40:
...
; #→[ 82] { { 181'(= {| l |} ) { } } 183'(5)◂184' } ⊢ { { 200'(= {| l |} ) 201'(6)◂202' } 203'(5)◂204' }
	lea rsp,[rsp-8*3]
...
;; %0~127'(= {| ? |} )%1~{ 133'(= r ) 134'(= {| ? |} ) }
; ##89 { { 133'(= r ) 134'(= {| ? |} ) } { %[ "ywww" ] %[ 5r ] } } ⊢ { { 171'(= r ) 172'(= {| ? |} ) } { 173'(= {| l |} ) 174'(6)◂175' } }
	push EXH_24
...
LB_31:
	...
	mov QWORD [SIG_FLG],0
;; %0~127'(= {| ? |} )%6~{ 171'(= r ) 172'(= {| ? |} ) }
; ##88 { { 171'(= r ) 172'(= {| ? |} ) } %[ "ywww" ] } ⊢ { { 207'(= r ) 208'(= {| ? |} ) } { 209'(= {| l |} ) 210'(6)◂211' } }
	push EXH_49
...
EXH_49:
	...
	jmp rax
;; rfb=f
LB_50: ;; #90◂◂(_none◂{}) 212'(= r ) ⊢ 0'(= {| l |} ) : (_r64◂→_s8◂)
JMP_50:
...
EXH_65:
	...
	jmp rax
;; rfb=f
LB_67: ;; #91◂◂(_none◂{}) 219'(= r ) ⊢ 0'(= r ) : (_r64◂→_r64◂)
JMP_67:
...
EXH_70:
	...
	jmp rax
;; rfb=f
LB_72: ;; #92◂◂(_none◂{}) 222'(= {| l |} ) ⊢ 0'(= {| l |} ) : (_s8◂→_s8◂)
JMP_72:
...
EXH_76:
	...
	jmp rax
;; rfb=f
LB_85: ;; #93◂◂(_none◂{}) { 232'(= r ) 233'(= r ) { 234'(= r ) 235'(= r ) } } ⊢ { 0'(= r ) { 1'(= r ) 2'(= r ) } } : ({ _r64◂ _r64◂{ _r64◂ _r64◂}}→{ _r64◂ { _r64◂ _r64◂}})
JMP_85:
...
EXH_86:
	...
	jmp rax
;; rfb=f
LB_103: ;; #94◂◂(_none◂{}) { 249'(= r ) 250'(= r ) } ⊢ { 0'(= r ) 1'(= r ) } : ({ _r64◂ _r64◂}→{ _r64◂ _r64◂})
JMP_103:
...
; ##65 244'(= [| _ |] ) ⊢ { 244'(= [| _ |] ) 256'(= [| _ |] ) }
	...
	mov QWORD [rax+8],rsi 
	mov QWORD [rax+16],1 
;; %0~127'(= {| ? |} )%7~{ 207'(= r ) 208'(= {| ? |} ) }%9~210'(6)◂211'%36~245'(= [| _ |] )%38~246'(= [| _ |] )%43~247'(= [| _ |] )%47~244'(= [| _ |] )%48~256'(= [| _ |] )
; ##8 244'(= [| _ |] ) ⊢ 244'(= [| _ |] )
	mov QWORD [SIG_FLG],1
	mov QWORD [SIG_ETR],emt_bof_hdl
	EMT_CST fmt_emt,64
...
LB_110:
	...
	EMT_FLSH
	mov QWORD [SIG_FLG],0
;; %0~127'(= {| ? |} )%7~{ 207'(= r ) 208'(= {| ? |} ) }%9~210'(6)◂211'%36~245'(= [| _ |] )%38~246'(= [| _ |] )%43~247'(= [| _ |] )%48~256'(= [| _ |] )%49~244'(= [| _ |] )
; ##66 { 244'(= [| _ |] ) 256'(= [| _ |] ) %[ 99r ] } ⊢ { 244'(= [| _ |] ) 256'(= [| _ |] ) }
	mov rdi,GLX(244)
	mov rax,GLX(256)
	mov rsi,QWORD [rax+8]
	bt rsi,63 
	...
	mov rax,99
	mov DX(0),rax
;; %0~127'(= {| ? |} )%7~{ 207'(= r ) 208'(= {| ? |} ) }%9~210'(6)◂211'%36~245'(= [| _ |] )%38~246'(= [| _ |] )%43~247'(= [| _ |] )%50~244'(= [| _ |] )%51~256'(= [| _ |] )
; ##8 244'(= [| _ |] ) ⊢ 244'(= [| _ |] )
	mov QWORD [SIG_FLG],1
	mov QWORD [SIG_ETR],emt_bof_hdl
	EMT_CST fmt_emt,64
...
LB_113:
	...
	EMT_FLSH
	mov QWORD [SIG_FLG],0
;; %0~127'(= {| ? |} )%7~{ 207'(= r ) 208'(= {| ? |} ) }%9~210'(6)◂211'%36~245'(= [| _ |] )%38~246'(= [| _ |] )%43~247'(= [| _ |] )%51~256'(= [| _ |] )%52~244'(= [| _ |] )
; ∎
	jmp RTM_6
EXH_104:
	add rsp,8
