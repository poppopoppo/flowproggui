...
LB_8: db 100,65,66,67,105,101,105,0
LB_16: db 39,48,226,151,130,0
LB_17: db 39,49,226,151,130,0
LB_23: db 100,65,66,67,105,101,105,0
LB_31: db 39,48,226,151,130,0
LB_32: db 39,49,226,151,130,0
LB_39: db 56,55,51,56,51,0
LB_42: db 32,32,32,9,10,107,107,0
LB_46: db 32,32,32,9,10,107,107,0
section .text
	unt: dq 0x0
...
LB_26: ;; { }
	movzx rax,BYTE [r8+6]
	jmp QWORD [LB_29+8*rax]
 ; { } { }
LB_29: dq LB_27,LB_28
LB_27:
	EMT_CST LB_31,5
	EMT_CST fmt_rcd_box_l,4
	EMT_CST fmt_rcd_r,4
...
LB_33: ;; { }
	movzx rax,BYTE [r8+6]
	jmp QWORD [LB_36+8*rax]
 ; { } { }
LB_36: dq LB_34,LB_35
LB_34:
	jmp LB_37
LB_35:
	jmp LB_37
...
LB_44:
	cmp rax,rdi
	jge LB_45
	JZ_LINE_SPC BYTE [rsi+rax], LB_43
LB_45:
	mov rsi,unt_0
	mov RX1,rax
	mov RX2,rsi
; .dlt.ptn %[ "   \t\nkk" ]
;; rsp=0 , %21~2'(= a3◂ [..] )%20~1'(= r )%0~0'(= {| ? |} )
; ##8 { 1'(= r ) 2'(= a3◂ [..] ) } ⊢ { 1'(= r ) 2'(= a3◂ [..] ) }
	mov QWORD [SIG_FLG],1
	mov QWORD [SIG_ETR],emt_bof_hdl
	EMT_CST fmt_emt,64
...
LB_48:
	cmp rax,rdi
	jge LB_49
	JZ_SPC BYTE [rsi+rax], LB_47
LB_49:
	mov rsi,unt_0
	mov RX1,rax
	mov RX2,rsi
; .dlt.ptn %[ "   \t\nkk" ]
;; rsp=0 , %25~2'(= a3◂ [..] )%24~1'(= r )%0~0'(= {| ? |} )
; ##8 { 1'(= r ) 2'(= a3◂ [..] ) } ⊢ { 1'(= r ) 2'(= a3◂ [..] ) }
	mov QWORD [SIG_FLG],1
	mov QWORD [SIG_ETR],emt_bof_hdl
	EMT_CST fmt_emt,64
