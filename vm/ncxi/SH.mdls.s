...
LB_6: db 39,48,226,151,130,0
LB_7: db 39,49,226,151,130,0
section .text
	unt: dq 0x0
...
ss_end_rcd_31:
	...
	mov [rax],rsi 
	jmp RTM_0
LB_0: ;; #36◂◂(_none◂{}) 0'(= a2◂ [ r] ) ⊢ 0'(= a2◂ [ r] ) : (_lst◂_r64◂→_lst◂_r64◂)
JMP_0:
;; rsp=0 , %4~0'(= a2◂ [ r] )
; ∎ 0'(= a2◂ [ r] )
...
LB_21:
	movzx rax,BYTE [r8+6]
	jmp QWORD [LB_24+8*rax]
LB_24: dq LB_22,LB_23
LB_22:
	FREE_LN r8 
	mov r8,QWORD [r8+8]
	call LB_26
...
LB_31:
	movzx rax,BYTE [r8+6]
	jmp QWORD [LB_34+8*rax]
LB_34: dq LB_32,LB_33
LB_32:
	FREE_LN r8 
	mov r8,QWORD [r8+8]
	jmp LB_35
