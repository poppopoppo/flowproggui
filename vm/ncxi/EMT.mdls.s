...
RTM_0:
	push RTM_1
;; rsp=0 , 
; rsp_d=0, #28 { %[ "ABddegCD" ] %[ 0r ] } ⊢ { 0'(= {| l |} ) 1'(= r ) 2'(= a3◂ [ r] ) }
...
LB_56:
	movzx rax,BYTE [r8+6]
	jmp QWORD [LB_62+8*rax]
LB_62: dq LB_60,LB_61
LB_60:
	jmp LB_65
LB_64: db 39,48,226,151,130,0
LB_65:
	push rdx
	push rcx
	push r8
