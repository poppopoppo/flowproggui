...
; .mov_ptn %[ "Xo" ] ⊢ 1'(= {| l |} )
	...
	mov QWORD [rdi],rsi 
	mov r14,rax
;; rsp=0 , %14~2'(= {| l |} ) %13~%[ 1r ] %12~0'(= {| {| l |}|} ) %9~%[ "Fu" ] %8~%[ 7r ] 
; _emt %[ 1r ] ⊢ %[ 1r ]
	jmp LB_48
...
LB_52:
	...
	jmp LB_53
LB_53:
;; rsp=0 , %15~%[ 1r ] %14~2'(= {| l |} ) %12~0'(= {| {| l |}|} ) %9~%[ "Fu" ] %8~%[ 7r ] 
; _emt 2'(= {| l |} ) ⊢ 2'(= {| l |} )
	jmp LB_55
...
LB_57:
	...
	jmp LB_58
LB_58:
;; rsp=0 , %16~2'(= {| l |} ) %15~%[ 1r ] %12~0'(= {| {| l |}|} ) %9~%[ "Fu" ] %8~%[ 7r ] 
...
LB_82:
	...
	jmp LB_83
LB_83:
;; rsp=0 , %19~2'(= {| l |} ) %18~%[ 1r ] %17~0'(= {| {| l |}|} ) %9~%[ "Fu" ] %8~%[ 7r ] 
; ∎ { }
; .dlt.ptn 2'(= {| l |} )
	mov rdi,r8
	push rdx
