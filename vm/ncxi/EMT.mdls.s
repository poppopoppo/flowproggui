...
LB_6:
	...
	jmp LB_10
LB_10
;; rsp=2 , %3~1'(= r ) %2~0'(= r ) %1~9'(= r ) %0~8'(= r ) 
; _emt 0'(= r ) ⊢ 0'(= r )
	jmp LB_12
LB_11: db 95,101,109,116,58,0
LB_12:
	push rdx
	push rcx
	push r8
...
LB_15:
; .dlt.ptn 0'(= r )
;; rsp=2 , %3~1'(= r ) %1~9'(= r ) %0~8'(= r ) 
; _emt 1'(= r ) ⊢ 1'(= r )
	jmp LB_17
LB_16: db 95,101,109,116,58,0
LB_17:
	push rdx
	push rcx
	push r8
...
RTM_0:
	push RTM_1
;; rsp=0 , 
; rsp_d=0, #28 { %[ "ABCD" ] %[ 0r ] } ⊢ { 0'(= {| l |} ) 1'(= r ) 2'(= a3◂ [ r] ) }
; .mov_ptn2 { %[ "ABCD" ] %[ 0r ] } ⊢ { 0'(= {| l |} ) 1'(= r ) }
; .mov_ptn %[ 0r ] ⊢ 1'(= r )
	mov r14,0
; .mov_ptn %[ "ABCD" ] ⊢ 0'(= {| l |} )
	push rdx
