...
%macro ALC_RCD 2 ; n,reg-name!=rbx 
	add QWORD [SS_RCD_%1_C],1
	add QWORD [SS_RCD_%1_N],1 
	mov %2,[SS_RCD_%1_TOP]
	mov MCR_REG,[%2]
...
init_ss_rcd_1:
	mov QWORD [SS_RCD_1_N],0
	mov QWORD [SS_RCD_1_C],0
...
init_ss_rcd_2:
	mov QWORD [SS_RCD_2_N],0
	mov QWORD [SS_RCD_2_C],0
...
init_ss_rcd_3:
	mov QWORD [SS_RCD_3_N],0
	mov QWORD [SS_RCD_3_C],0
...
init_ss_rcd_4:
	mov QWORD [SS_RCD_4_N],0
	mov QWORD [SS_RCD_4_C],0
...
init_ss_rcd_5:
	mov QWORD [SS_RCD_5_N],0
	mov QWORD [SS_RCD_5_C],0
...
init_ss_rcd_6:
	mov QWORD [SS_RCD_6_N],0
	mov QWORD [SS_RCD_6_C],0
...
init_ss_rcd_7:
	mov QWORD [SS_RCD_7_N],0
	mov QWORD [SS_RCD_7_C],0
...
init_ss_rcd_8:
	mov QWORD [SS_RCD_8_N],0
	mov QWORD [SS_RCD_8_C],0
...
init_ss_rcd_9:
	mov QWORD [SS_RCD_9_N],0
	mov QWORD [SS_RCD_9_C],0
...
init_ss_rcd_10:
	mov QWORD [SS_RCD_10_N],0
	mov QWORD [SS_RCD_10_C],0
...
init_ss_rcd_11:
	mov QWORD [SS_RCD_11_N],0
	mov QWORD [SS_RCD_11_C],0
...
init_ss_rcd_12:
	mov QWORD [SS_RCD_12_N],0
	mov QWORD [SS_RCD_12_C],0
...
init_ss_rcd_13:
	mov QWORD [SS_RCD_13_N],0
	mov QWORD [SS_RCD_13_C],0
...
init_ss_rcd_14:
	mov QWORD [SS_RCD_14_N],0
	mov QWORD [SS_RCD_14_C],0
...
init_ss_rcd_15:
	mov QWORD [SS_RCD_15_N],0
	mov QWORD [SS_RCD_15_C],0
