...
LB_462: db 39,48,226,151,130,0
LB_464: db 39,49,226,151,130,0
LB_469: db 39,48,226,151,130,0
LB_471: db 39,49,226,151,130,0
LB_476: db 39,48,226,151,130,0
LB_478: db 39,49,226,151,130,0
LB_483: db 39,48,226,151,130,0
LB_484: db 39,49,226,151,130,0
LB_505: db 34,101,110,100,32,105,110,102,111,32,116,101,115,116,34,0
section .text
global _start
...
LB_463:
	movzx rax,BYTE [r8+6]
	jmp QWORD [LB_467+8*rax]
LB_467: dq LB_465,LB_466
LB_465:
	mov rdi,LB_469
	call emt_stg 
	mov r8,QWORD [r8+8]
...
LB_470:
	movzx rax,BYTE [r8+6]
	jmp QWORD [LB_474+8*rax]
LB_474: dq LB_472,LB_473
LB_472:
	mov rdi,LB_476
	call emt_stg 
	mov r8,QWORD [r8+8]
...
LB_477:
	movzx rax,BYTE [r8+6]
	jmp QWORD [LB_481+8*rax]
LB_481: dq LB_479,LB_480
LB_479:
	mov rdi,LB_483
	call emt_stg 
	mov r8,QWORD [r8+8]
