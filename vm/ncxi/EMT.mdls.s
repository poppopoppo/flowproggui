...
; .mov_ptn 3t' ⊢ 0t'
	...
	mov r13,rax
	lea rsp,[rsp+8*3]
;; rsp=0 , %53~3t' %52~4t' %51~5t' %50~6t' %49~0t' %47~2t' %46~1t' 
; ∎ { 1t' 2t' 0t' 3t' }
...
; .mov_ptn %[ 20r ] ⊢ 0t'
	...
	mov r13,rax
	lea rsp,[rsp+8*2]
;; rsp=0 , %63~3t' %62~2t' %61~4t' %60~5t' %59~1t' %57~0t' 
	mov rsi,r9
	push rdx
	push rcx
	push r8
	...
	pop rcx
	pop rdx
;; rsp=0 , %64~3t' %62~2t' %61~4t' %60~5t' %59~1t' %57~0t' 
; ∎ { }
; .mov_ptn2 { } ⊢ { }
	ret
RTM_1:
